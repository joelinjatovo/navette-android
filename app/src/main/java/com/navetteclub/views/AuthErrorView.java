...
public class AuthErrorView extends LinearLayout {
    ...
    public AuthErrorView(Context context) {
        super(context);
        init(context, null, 0);
    }

    public AuthErrorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public AuthErrorView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        View view = mInflater.inflate(R.layout.view_error_auth, this, true);
